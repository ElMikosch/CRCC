	...
	return [
		{
			"Name": "Agent",
			"Name_DE": "Agent",
			"Description": "Self-adaptive AI powered smartphone. +2 to Library Search. +2 to Wardrobe and Style under some circumstances. See pg. 352 for more information.",
			"Description_DE": "Selbstanpassendes KI-gesteuertes Smartphone. +2 auf Bibliothekssuche. +2 auf Garderobe und Stil unter bestimmten Umständen. Siehe S. 352 für weitere Informationen.",
		...
		},
		{
			...
			"Description_DE": "Piepst, wenn sich das Gerät in einer Entfernung von 2 m von einer Abhöranlage befindet.",
		...
		},
		{
			...
			"Description": "Can test chemical composition of substance against a database of samples.",
			"Description_DE": "Kann die chemische Zusammensetzung einer Substanz anhand einer Datenbank von Proben prüfen.",
			"CostDescription": "1000eb (V. Expensive)",
			"Cost": 1000
		},
		{
		...
		},
		{
			"Name": "Cyberdeck",
			"Name_DE": "Cyberdeck",
			"Description": "Basic deck for netrunning. 7 slots. See pg. 353 for more information.",
			"Description_DE": "Basis-Deck für Netrunning. 7 Steckplätze. Siehe S. 353 für weitere Informationen.",
			"CostDescription": "500eb (Expensive)",
			"Cost": 500
		},
		{
			...
			"Description_DE": "Erledigt Anrufe. Kann bei Bedarf leicht entsorgt werden.",
			"CostDescription": "50eb (Costly)",
			"Cost": 50
		},
		{
			...
			"Description_DE": "Kann fast jede Art von Trommel simulieren. Benötigt Verstärker.",
			"CostDescription": "500eb (Expensive)",
			"Cost": 500
		},
		{
		...
		},
		{
			...
			"Description_DE": "Gut zum Musizieren. Elektrische Versionen brauchen Verstärker.",
			"CostDescription": "500eb (Expensive) - Flashlight",
			"Cost": 500
		},
		{
			"Name": "Food Stick",
		...
		},
		{
			...
			"Description": "Fires a grapple line up to 30m/yds. Cannot be used as a weapon.",
			"Description_DE": "Feuert eine Fangleine bis zu 30m/yds. Kann nicht als Waffe verwendet werden.",
		...
		},
		{
			...
			"Description_DE": "Kann einem verknüpften Tracer bis zu 1 Meile weit folgen.",
			"CostDescription": "500eb (Expensive)",
			"Cost": 500
		},
		{
		...
		},
		{
			"Name": "Medscanner",
			"Name_DE": "Medscanner",
			"Description": "Helps diagnose illness and injury. +2 to First Aid and Paramedic.",
			"Description_DE": "Hilft bei der Diagnose von Krankheiten und Verletzungen. +2 bis Erste Hilfe und Rettungssanitäter.",
			"CostDescription": "1000eb (V. Expensive)",
			"Cost": 1000
		},
		{
			...
			"Description_DE": "Ein kompletter medizinischer Werkzeugkasten in einer Tasche.",
			"CostDescription": "100eb (Premium)",
			"Cost": 100
		},
		{
		...
		},
		{
			...
			"Description_DE": "Selbsterhitzende Mahlzeitentasche aus Kunststoff und Folie.",
			"CostDescription": "10eb (Cheap)",
			"Cost": 10
		},
		{
		...
		},
		{
			...
			"Description": "Can support up to two instruments. Lasts 6 hours per charge.",
			"Description_DE": "Kann bis zu zwei Instrumente unterstützen. Hält 6 Stunden pro Ladung.",
			"CostDescription": "50eb (Costly)",
			"Cost": 50
		},
		{
			...
			"Description_DE": "Piept, wenn es sich innerhalb von 100m/yd eines aktiven Radarstrahls befindet.",
			"CostDescription": "500eb (Expensive)  Radiation Suit",
			"Cost": 500
		},
		{
		...
		},
		{
			...
			"Description": "Play the hottest music or tune into radio bands within 1-mile.",
			"Description_DE": "Spielen Sie die angesagteste Musik oder hören Sie Radiosender im Umkreis von 1 Meile.",
			"CostDescription": "50eb (Costly)",
			"Cost": 50
		},
		{
		...
		},
		{
			...
			"Description": "Technologically enhanced glasses. Has 2 slots for Cyberoptic Options.",
			"Description_DE": "Technologisch verbesserte Brille. Verfügt über 2 Steckplätze für cyberoptische Optionen.",
			"CostDescription": "500eb (Expensive)",
			"Cost": 500
		},
		{
		...
		},
		{
			"Name": "Techscanner",
			"Name_DE": "Techscanner",
			"Description": "Helps diagnose broken tech. +2 to multiple TECH-based Skills.",
			"Description_DE": "Hilft bei der Diagnose von kaputter Technik. +2 auf mehrere TECH-basierte Fertigkeiten.",
			"CostDescription": "1000eb (V. Expensive)",
			"Cost": 1000
		},
		{
		...
		},
		{
			...
			"Description": "Does damage 3d6. Resisted by Resist Torture/Drugs. Not affected by armor.",
			"Description_DE": "Macht 3d6 Schaden. Widersteht Folter/Drogen widerstehen. Wird nicht von Rüstung beeinflusst.",
			"CostDescription": "500eb (Expensive)",
			"Cost": 500
		},
		{
			...
			"Description": "Does damage 2d6. Resisted by Resist Torture/Drugs. Not affected by armor.",
			"Description_DE": "Verursacht 2d6 Schaden. Widersteht Folter/Drogen widerstehen. Wird nicht von Rüstung beeinflusst.",
			"CostDescription": "100eb (Premium)",
			"Cost": 100
		},
		{
			"Name": "Video Camera",
			"Name_DE": "Videokamera",
			"Description": "Record up to 12 hours of audio and video on a single memory chip.",
			"Description_DE": "Nehmen Sie bis zu 12 Stunden Audio- und Videomaterial auf einem einzigen Speicherchip auf.",
			"CostDescription": "100eb (Premium)",
			"Cost": 100
		},
		{
			...
			"Description_DE": "Projiziert Bilder aus dem Cyberspace über die reale Weltansicht.",
			"CostDescription": "100eb (Premium)",
			"Cost": 100
		}
	]
