    ...
    },
    {
      ...
      Skills: [
        ...
        },
        {
          ...
          Name_DE: 'Abzug',
          Description_EN:
            "Skill of taking several clues and leaping to a non-obvious conclusion or medical diagnosis. At a Base 10, you can put two and two together and figure out most logical leaps, no problem. You can always deduce where you left your keys or how likely it is that the rash on your arm is deadly. At a Base 14, you have trained your mind to collect clues and organize them to make better deductions. You can make accurate long-range deductions like how long it will be before the gangers figure out you sold them dud cyberware. At a Base 18, your skills rival that of Sherlock Holmes. You are at the level of a world-class detective, building accurate deductions and predictions from the smallest clues imaginable. Some people may even think you're psychic.",
          Description_DE:
            'Die Fähigkeit, aus mehreren Hinweisen eine nicht offensichtliche Schlussfolgerung zu ziehen oder eine medizinische Diagnose zu stellen. Bei einem Basiswert von 10 kannst du zwei und zwei zusammenzählen und die meisten logischen Schlüsse problemlos ziehen. Du kannst immer ableiten, wo du deine Schlüssel vergessen hast oder wie wahrscheinlich es ist, dass der Ausschlag auf deinem Arm tödlich ist. Mit Base 14 hast du deinen Verstand darauf trainiert, Hinweise zu sammeln und sie zu ordnen, um bessere Schlussfolgerungen zu ziehen. Du kannst genaue, weitreichende Schlussfolgerungen ziehen, z. B. wie lange es dauern wird, bis die Ganger herausfinden, dass du ihnen gefälschte Cyberware verkauft hast. Mit einem Basiswert von 18 sind deine Fähigkeiten mit denen von Sherlock Holmes vergleichbar. Du bist auf dem Niveau eines Weltklasse-Detektivs, der aus den kleinsten Anhaltspunkten genaue Schlussfolgerungen und Vorhersagen macht. Manche Leute halten Sie sogar für einen Hellseher.',
          Stat: 'INT',
        },
        {
          CostFactor: 1,
        ...
        },
        {
          ...
          Name_DE: 'Sprache',
          Description_EN:
            "Skill of speaking a particular language. You must choose a specific language whenever you increase this Skill. At a Base 10, you can speak the language well enough to get by on the street but you don't understand a lot of the slang. At a Base 14, you are a fluent speaker of the language and most people assume you grew up speaking the language. At a Base 18, you not only speak the language fluently but you know all the ins and outs of the language including slang, complicated situational rules, and all dialects of the language.",
          Description_DE:
            'Fertigkeit, eine bestimmte Sprache zu sprechen. Du musst eine bestimmte Sprache wählen, wenn du diese Fertigkeit erhöhst. Mit Basis 10 kannst du die Sprache gut genug sprechen, um dich auf der Straße zurechtzufinden, aber du verstehst nicht viel von der Umgangssprache. Mit Basis 14 sprichst du die Sprache fließend und die meisten Leute gehen davon aus, dass du mit dieser Sprache aufgewachsen bist. Mit Base 18 sprechen Sie die Sprache nicht nur fließend, sondern kennen auch alle Einzelheiten der Sprache, einschließlich der Umgangssprache, komplizierter situationsbezogener Regeln und aller Dialekte der Sprache.',
          Stat: 'INT',
          Minimum: 2,
        },
        {
        ...
        },
        {
          ...
          Description_EN:
            'Skill for knowing how to design experiments, write scientific papers, test hypotheses, and discuss with other academics in a particular field of science. An area of study must be specified whenever this Skill is increased. Possible options include',
          Description_DE:
            'Die Fähigkeit, Experimente zu planen, wissenschaftliche Arbeiten zu verfassen, Hypothesen zu testen und mit anderen Wissenschaftlern in einem bestimmten Bereich der Wissenschaft zu diskutieren. Bei jeder Erhöhung dieser Fähigkeit muss ein Studienbereich angegeben werden. Mögliche Optionen sind',
          Stat: 'INT',
        },
      ],
    },
    {
      ...
      Skills: [
        ...
        },
        {
          ...
          Description_EN:
            'Skill for fighting with a Martial Arts Form. Each time you increase this Skill you must choose in which form you are training. You can learn multiple forms, but you must do so separately. Possible options',
          Description_DE:
            'Fertigkeit für den Kampf mit einer Kampfkunstform. Jedes Mal, wenn du diese Fertigkeit erhöhst, musst du wählen, in welcher Form du trainierst. Du kannst mehrere Formen erlernen, aber du musst dies separat tun. Mögliche Optionen',
          Stat: 'DEX',
        },
      ],
    },
    ...
    },
    {
      ...
      Skills: [
        ...
        },
        {
          ...
          Description_EN:
            'Skill of producing professional paintings, drawings, or sculpture. At a Base 10, you are skilled enough to create works of art that actually make you significant money on the market. At a Base 14, you have the skill to really start getting some recognition for your talent. Your art is, maybe, featured in some screamsheets or Data Pool articles. At a Base 18, you could be nationally known, have exhibits in galleries, and have other lesser artists studying your style in art school.',
          Description_DE:
            'Die Fähigkeit, professionelle Gemälde, Zeichnungen oder Skulpturen herzustellen. Mit einem Basiswert von 10 sind Sie in der Lage, Kunstwerke zu schaffen, mit denen Sie auf dem Markt Geld verdienen können. Mit einem Basiswert von 14 haben Sie die Fähigkeit, wirklich Anerkennung für Ihr Talent zu bekommen. Ihre Kunst wird vielleicht in einigen Screamsheets oder Data-Pool-Artikeln gezeigt. Mit Base 18 könnten Sie landesweit bekannt sein, in Galerien ausgestellt werden und andere weniger begabte Künstler Ihren Stil in der Kunstschule studieren.',
          Stat: 'TECH',
        },
        {
          CostFactor: 2,
        ...
        },
        {
          ...
          Name_DE: 'Weaponstech',
          Description_EN:
            'Skill for repairing and maintaining weapons of all types. The DV and amount of time it takes you to repair a damaged/destroyed item with this Skill to perfect condition is based on the Price Category of the item',
          Description_DE:
            'Fertigkeit zum Reparieren und Warten von Waffen aller Art. Die DV und die Zeit, die du brauchst, um einen beschädigten/zerstörten Gegenstand mit dieser Fertigkeit in einen perfekten Zustand zu bringen, hängt von der Preiskategorie des Gegenstands ab',
          Stat: 'TECH',
        },
      ],
    },
