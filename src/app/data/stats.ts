...
export function getAllStats(): Stat[] {
		return [
		{
			...
			description_DE: "Wie intelligent Sie im Allgemeinen sind. Das ist in der Regel mehr als bloße Intelligenz, sondern umfasst auch Klugheit, Aufmerksamkeit, Wahrnehmung und Lernfähigkeit.",
			isDerived: false,
		...
		},
		{
			...
			description_DE: "Ihre Entschlossenheit und Fähigkeit, sich Gefahren und/oder Stress zu stellen. Dieser STAT steht auch für Ihren Mut und Ihre Fähigkeit, langfristige Entbehrungen zu überleben. Dieser STAT ist wichtig, um zu bestimmen, wie viel Schaden Sie ertragen können.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Ihre Fähigkeit, Menschen durch Ihren Charakter und Ihr Charisma zu beeindrucken und zu beeinflussen; wie gut Sie mit anderen auskommen; wie Sie in sozialen Situationen interagieren.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Ihre Fähigkeit, mit anderen in Beziehung zu treten, sich um sie zu kümmern und auf sie Rücksicht zu nehmen. Dies ist besonders wichtig, da es die Auswirkungen der Cyberpsychose ausgleicht, einer gefährlichen Geisteskrankheit, die in der Dunklen Zukunft weit verbreitet ist.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Deine Reaktionszeit und Koordination, wie sie beim Zielen, Werfen, Jonglieren usw. gebraucht wird. Ein Bühnenmagier hätte zum Beispiel einen hohen Reflex-STAT. Vor allem ist dies der STAT, der deine Fähigkeit beeinflusst, Dinge mit Fernkampfwaffen zu treffen.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Deine Größe, Zähigkeit und Fähigkeit, am Leben und bei Bewusstsein zu bleiben, aufgrund von physischer Masse, Struktur oder anderen Eigenschaften. Dieser STAT ist wichtig, um zu bestimmen, wie viel Schaden du einstecken kannst.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Ihre Bewegungsgeschwindigkeit: Laufen, Springen, Schwimmen, usw.",
			isDerived: false,
            derivedCalculation: (stat1: number, stat2: number) => 0,
			value: 2,
			minValue: 2,
		...
		},
		{
			...
			description_DE: "Die Trefferpunkte sind das, was wir zählen, um festzustellen, ob dein Charakter tot ist oder nur noch blutend auf dem Boden liegt.",
			isDerived: true,
